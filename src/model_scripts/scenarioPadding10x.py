...
def run(
    ...
    early_stop=False,
    data_path=PROJECT_ROOT / "data/interim/vdjdb-human-trb-no10x.csv",
    validation_path=PROJECT_ROOT / "data/interim/vdjdb-human-trb-10xonly.csv"
    # neg_ref: bool = True,
    ...
    train = dataSource
    val = DataStream(list(VdjdbSource(filepath=validation_path)))
