...
--regularization 0.01 \
--optimizer rmsprop \
--name "trbmhcidown400-epitope_grouped-shuffle-padded-b32-lre4-reg001-local" 2>&1 | tee -a "trbmhcidown400-epitope_grouped-shuffle-padded-b32-lre4-reg001-local.log"
...
--learning_rate 0.001 \
--optimizer rmsprop \
--name "trbmhcidown400-epitope_grouped-shuffle-nettcr-b32-lre3-lrr-local" 2>&1 | tee -a "trbmhcidown400-epitope_grouped-shuffle-nettcr-b32-lre3-lrr-local.log"
...
--learning_rate 0.0001 \
--optimizer rmsprop \
--name "trbmhcidown400-epitope_grouped-shuffle-nettcr-b32-lre4-lrr-local" 2>&1 | tee -a "trbmhcidown400-epitope_grouped-shuffle-nettcr-b32-lre4-lrr-local.log"
